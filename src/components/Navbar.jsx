        ...
        <nav className='flex justify-between items-center'>
            ...
            <div className='flex items-center md:gap-16 gap-4'>
                ...
                <div className='relative sm:w-72 w-40 space-x-2'>
                  ...
                  <GoSearch className='absolute inline-block left-3 inset-y-2'/>
                ...
                <div>
                    {
                        ...
                        <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                            <img src={avatarImg} alt="" className={`size-7 rounded-full ${currentUser ? 'ring-2 ring-blue-700' : ''}`} />
                        </button>
                        {/* show dropdowns */}
                        {
                            isDropdownOpen && (
                        ...
                        </> : <Link to='/login'><LuUserRoundPlus className='size-6' /></Link>
                    }
                </div>
